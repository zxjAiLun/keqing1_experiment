#!/usr/bin/env python3
"""Execute four-player evaluation for M1 ext_mortal expansion absolute promotion."""
...
DEFAULT_OUTPUT_DIR = REPO_ROOT / "artifacts/experiments/M1_ext_mixed_expansion_2026_08/evaluation_implementation_2026_08"
...
def build_shard_command(
    ...
    # Lineup order: 70k, ext_mortal, M0_CURRENT_<seed>, M1_CURRENT_<seed>
    for m in lineup:
...
def run_full_evaluation(output_dir: Path, device: str = DEVICE, shard: int | None = None) -> None:
    ...
    manifest_path = output_dir / "m1_input_manifest.json"
